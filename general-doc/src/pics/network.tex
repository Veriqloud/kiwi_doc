\documentclass[border=3mm, convert={density=400}]{standalone} %left bottom rigth top
...
\begin{tikzpicture}%[text=vq_grey]
    \node (a) at (0,0) {Alice};
    \node (b) at (8,0) {Bob};
    \node (client1) at (0,2) {client / admin};
    \node (client2) at (8,2) {client / admin};

    \draw (a) -- (b) node[midway, above]{eth-wrs};
    \draw (a) -- (client1) node[midway, right]{eth-client};
    \draw (b) -- (client2) node[midway, right]{eth-client};

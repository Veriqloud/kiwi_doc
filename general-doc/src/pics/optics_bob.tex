...
\node (b1) [block] {\textbf{Optical filter}} ;
\node (b2) [block, right=of b1] {\textbf{Polarization Modulator}};
\node (b3) [block,right=of b2] {\textbf{In Line Polarizer}};
\node (b4) [block, fill=pink!20,right=of b3] {\textbf{Phase Modulator}} ;
\node (b5) [block, fill=blue!60, right=of b4] {\textbf{Interferometer}} ;

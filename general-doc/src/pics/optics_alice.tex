...
\node (b1) [block, fill=blue!20] {\textbf{External Laser}};
\node (b2) [block, fill=pink!20, right=of b1] {\textbf{Amplitude Modulator}};
\node (b3) [block, fill=pink!20,right=of b2]  {\textbf{Phase Modulator}};
\node (b4) [block,right=of b3] {\textbf{Optical Filter}} ;
\node (b5) [block,right=of b4] {\textbf{Variable Attenuator}} ;
\node (b6) [block,right=of b5] {\textbf{Manual Attenuator}};

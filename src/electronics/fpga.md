...
The project includes a block design with :
- XDMA
- Clock and reset
- Fastdac
- TDC 
...
Documentation of vivado project hopefully helps developper recall project in case of debug in the future. Then what will be archived:
- System level : architecture, clock tree, reset system, data flows, links between blocks and QKD protocol. Purpose is to have a general picture of system in processor. 
- Blocks level : Dive in details of each block. Consider each block is supposed to be packaged as an independent IP. Explain all modules inside blocks, fucntions and data paths
- Verification level: test cases, issues, reports, CDC, constraints

Sources of doc:
- Mostly of files were written manually. Recommend using RTL modules as source of truth. It's essential to look at block design, RTL sources, IPs while reading this Vivado project documentation
...
You can only have access to ILA debug windows in Vivado by JTAG. With this solution, you also can check the Calibration Process of DDR4.
